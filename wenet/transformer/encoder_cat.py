...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        # Note: this project's `encoder_cat` outputs the concatenation (cat) of per-layer features
        # to match the pooling input channels = output_size * num_blocks design (and existing checkpoints).
